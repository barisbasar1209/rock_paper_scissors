...
public class Util {
	...
	final static String[][] smallBlueH = {
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+"#","#","#","#","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET}};
	final static String[][] smallBlueT = {
			{BLUE+"#","#","#","#"," "," "," "," "," "+RESET},
			{BLUE+" "," ","#"," "," "," "," "," "," "+RESET},
			{BLUE+" "," ","#"," "," "," "," "," "," "+RESET},
			{BLUE+" "," ","#"," "," "," "," "," "," "+RESET},
			{BLUE+" "," ","#"," "," "," "," "," "," "+RESET}};
	final static String[][] smallBlueN = {
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+"#","#"," "," ","#"," "," "," "," "+RESET},
			{BLUE+"#"," ","#"," ","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," ","#","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET}};
	final static String[][] smallBlueF = {
			{BLUE+"#","#","#","#","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," "," "," "," "," "," "+RESET},
			{BLUE+"#","#","#","#"," "," "," "," "," "+RESET},
			{BLUE+"#"," "," "," "," "," "," "," "," "+RESET},
	...
	final static String[][] smallBlueG = {
			...
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+"#","#","#","#","#"," "," "," "," "+RESET}};
	final static String[][] smallBlueX = {
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+" ","#"," ","#"," "," "," "," "," "+RESET},
			{BLUE+" "," ","#"," "," "," "," "," "," "+RESET},
			{BLUE+" ","#"," ","#"," "," "," "," "," "+RESET},
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET}};
	final static String[][] smallBlueC = {
			{BLUE+" ","#","#","#"," "," "," "," "," "+RESET},
			{BLUE+"#"," "," "," "," "," "," "," "," "+RESET},
			{BLUE+"#"," "," "," "," "," "," "," "," "+RESET},
			{BLUE+"#"," "," "," "," "," "," "," "," "+RESET},
			{BLUE+" ","#","#","#"," "," "," "," "," "+RESET}};
	final static String[][] smallBlueE = {
			{BLUE+"#","#","#","#","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," "," "," "," "," "," "+RESET},
			{BLUE+"#","#","#","#"," "," "," "," "," "+RESET},
			{BLUE+"#"," "," "," "," "," "," "," "," "+RESET},
			{BLUE+"#","#","#","#","#"," "," "," "," "+RESET}};
	final static String[][] smallBlueI = {
			{BLUE+"#","#","#","#","#"," "," "," "," "+RESET},
			{BLUE+" "," ","#"," "," "," "," "," "," "+RESET},
			{BLUE+" "," ","#"," "," "," "," "," "," "+RESET},
			{BLUE+" "," ","#"," "," "," "," "," "," "+RESET},
			{BLUE+"#","#","#","#","#"," "," "," "," "+RESET}};
	final static String[][] smallBlueO = {
			{BLUE+" ","#","#","#"," "," "," "," "," "+RESET},
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," ","#"," "," "," "," "+RESET},
			{BLUE+" ","#","#","#"," "," "," "," "," "+RESET}};
	final static String[][] smallBlueS = {
			{BLUE+" ","#","#","#","#"," "," "," "," "+RESET},
			{BLUE+"#"," "," "," "," "," "," "," "," "+RESET},
			{BLUE+" ","#","#","#"," "," "," "," "," "+RESET},
			{BLUE+" "," "," "," ","#"," "," "," "," "+RESET},
